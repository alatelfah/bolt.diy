...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with Hero Builder
      doc.setFontSize(12);
      doc.text('Hero Builder - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.setFontSize(10);
        doc.text('Generated by Hero Builder', margin, doc.internal.pageSize.getHeight() - 10);
